...
curl -s -XPUT "$ADDRESS/get-together/group/1" -H 'content-Type:application/json' -d'{
  "name": "Denver Clojure",
...
echo
curl -s -XPUT "$ADDRESS/get-together/group/2" -H 'content-Type:application/json' -d'{
...
echo
curl -s -XPUT "$ADDRESS/get-together/group/3" -H 'content-Type:application/json' -d'{
...
echo
curl -s -XPUT "$ADDRESS/get-together/group/4" -H 'content-Type:application/json' -d'{
...
echo
curl -s -XPUT "$ADDRESS/get-together/group/5" -H 'content-Type:application/json' -d'{
...
curl -s -XPUT "$ADDRESS/get-together/event/100?parent=1" -H 'content-Type:application/json' -d'{
  "host": ["Lee", "Troy"],
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/101?parent=1" -H 'content-Type:application/json' -d'{
  "host": "Sean",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/102?parent=1" -H 'content-Type:application/json' -d'{
  "host": "Daniel",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/103?parent=2" -H 'content-Type:application/json' -d'{
  "host": "Lee",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/104?parent=2" -H 'content-Type:application/json' -d'{
  "host": "Lee",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/105?parent=2" -H 'content-Type:application/json' -d'{
  "host": "Lee",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/106?parent=3" -H 'content-Type:application/json' -d'{
  "host": "Mik",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/107?parent=3" -H 'content-Type:application/json' -d'{
  "host": "Mik",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/108?parent=3" -H 'content-Type:application/json' -d'{
  "host": "Elyse",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/109?parent=4" -H 'content-Type:application/json' -d'{
  "host": "Andy",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/110?parent=4" -H 'content-Type:application/json' -d'{
  "host": "Andy",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/111?parent=4" -H 'content-Type:application/json' -d'{
  "host": "Andy",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/112?parent=5" -H 'content-Type:application/json' -d'{
  "host": "Dave Nolan",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/113?parent=5" -H 'content-Type:application/json' -d'{
  "host": "Dave",
...
echo
curl -s -XPUT "$ADDRESS/get-together/event/114?parent=5" -H 'content-Type:application/json' -d'{
  "host": "Yann",
